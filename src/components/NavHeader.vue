    ...
    <header class="header">
        ...
        <div class="navbar">
            <div class="navbar-left-container">
                <a href="/"><img class="navbar-brand-logo"></a>
            </div>
            <div class="navbar-right-container" style="display: flex;">
                <div class="navbar-menu-container">
                    ...
                    <div class="navbar-cart-container">
                        <span class="navbar-cart-count" v-text="cartCount" v-if="nickName!== ''&& cartCount>0"></span>
    ...
    methods: {
        checkLogin(){
            axios.get('user/checkLogin').then(response=>{
                ...
                if(res.status == 200){
                    this.$store.commit("getUser",res.result.userName);
                    this.getCartCount();
                }else{
        ...
        login(){
            axios.post('/user/login',{userName:this.userName,userPwd:this.userPwd}).
            then(response=>{
                const res = response.data;
                if(res.status == 200){
                    this.$store.commit("getUser",res.result.userName);
        ...
        getCartCount(){
            axios.get('user/getCartCount').then(response=>{
                const res = response.data;
                if(res.status == 200){
